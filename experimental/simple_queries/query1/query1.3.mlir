module attributes {llvm.data_layout = ""} {
  ...
  ^bb5:  // pred: ^bb4
    ...
    %105 = llvm.getelementptr %104[%103] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    ...
    %111 = llvm.getelementptr %110[%103] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
