...
static ::mlir::LogicalResult __mlir_ods_local_type_constraint_Ops1(
    ::mlir::Operation *op, ::mlir::Type type, ::llvm::StringRef valueKind,
    unsigned valueIndex) {
  if (!((((type.isa<::mlir::TensorType>())) && ([](::mlir::Type elementType) { return (elementType.isF64()); }(type.cast<::mlir::ShapedType>().getElementType()))) && ((type.cast<::mlir::ShapedType>().hasStaticShape())))) {
    return op->emitOpError(valueKind) << " #" << valueIndex
...
GenericCallOpAdaptor::GenericCallOpAdaptor(::mlir::ValueRange values, ::mlir::DictionaryAttr attrs, ::mlir::RegionRange regions) : odsOperands(values), odsAttrs(attrs), odsRegions(regions) {  if (odsAttrs)
    odsOpName.emplace("toy.generic_call", odsAttrs.getContext());
}

GenericCallOpAdaptor::GenericCallOpAdaptor(GenericCallOp op) : odsOperands(op->getOperands()), odsAttrs(op->getAttrDictionary()), odsRegions(op->getRegions()), odsOpName(op->getName()) {}

::mlir::ValueRange GenericCallOpAdaptor::getOperands() {
  return odsOperands;
}
...
::mlir::ValueRange GenericCallOpAdaptor::getInputs() {
  return getODSOperands(0);
}

::mlir::DictionaryAttr GenericCallOpAdaptor::getAttributes() {
  return odsAttrs;
}

::mlir::FlatSymbolRefAttr GenericCallOpAdaptor::getCalleeAttr() {
  assert(odsAttrs && "no attributes when constructing adapter");
...
::llvm::StringRef GenericCallOpAdaptor::getCallee() {
...
::mlir::LogicalResult GenericCallOp::verifyInvariantsImpl() {
  ...
  if (::mlir::failed(__mlir_ods_local_attr_constraint_Ops3(*this, tblgen_callee, "callee")))
    return ::mlir::failure();
  {
    unsigned index = 0; (void)index;
    auto valueGroup0 = getODSOperands(0);
...
::mlir::Value PrintOpAdaptor::getInput() {
  return *getODSOperands(0).begin();
}
...
::mlir::Value ReshapeOpAdaptor::getInput() {
  return *getODSOperands(0).begin();
}
...
::mlir::ValueRange ReturnOpAdaptor::getInput() {
  return getODSOperands(0);
}
...
::mlir::ParseResult ReturnOp::parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result) {
  ::mlir::SmallVector<::mlir::OpAsmParser::UnresolvedOperand, 4> inputOperands;
...
::mlir::Value TransposeOpAdaptor::getInput() {
  return *getODSOperands(0).begin();
}
...
::mlir::Value TransposeOp::getInput() {
  return *getODSOperands(0).begin();
}
